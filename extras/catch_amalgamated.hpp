...
//  Generated: 2022-04-26 23:43:37.987745
//  ----------------------------------------------------------
...
namespace Catch {
    ...
    class CATCH_DLL_PUBLIC IMutableEnumValuesRegistry {
    public:
...
namespace Catch {
    ...
    CATCH_DLL_PUBLIC Detail::unique_ptr<ColourImpl> makeColourImpl( ColourMode colourSelection,
                                                   IStream* stream );
...
namespace Catch {
    ...
    namespace Detail {
        ...
        CATCH_DLL_PUBLIC std::vector<std::string> splitReporterSpec( StringRef reporterSpec );

        CATCH_DLL_PUBLIC Optional<ColourMode> stringToColourMode( StringRef colourMode );
    }
     ...
     * openable.
     */
    class CATCH_DLL_PUBLIC ReporterSpec {
        std::string m_name;
        Optional<std::string> m_outputFileName;
        Optional<ColourMode> m_colourMode;
        std::map<std::string, std::string> m_customOptions;

        CATCH_DLL_PUBLIC friend bool operator==( ReporterSpec const& lhs,
     ...
     *  * ...
     */
    CATCH_DLL_PUBLIC Optional<ReporterSpec> parseReporterSpec( StringRef reporterSpec );
...
namespace Catch {
    ...
    struct CATCH_DLL_PUBLIC TagAlias {
...
namespace Catch {
    ...
    class CATCH_DLL_PUBLIC ITestInvoker {
    public:
    ...
    class CATCH_DLL_PUBLIC ITestCaseRegistry {
    public:
...
namespace Catch {
    ...
    Detail::unique_ptr<ITestInvoker>
        CATCH_DLL_PUBLIC makeTestInvoker( void ( *testAsFunction )() );
...
struct CATCH_DLL_PUBLIC NameAndTags {
...
struct CATCH_DLL_PUBLIC AutoReg : Detail::NonCopyable {
...
#    define INTERNAL_CATCH_TESTCASE_METHOD_NO_REGISTRATION(   \
        ...
        namespace {                                           \
            struct CATCH_DLL_PUBLIC TestName                  \
                : INTERNAL_CATCH_REMOVE_PARENS( ClassName ) { \
                void test();                                  \
            };                                                \
        }                                                     \
        void TestName::test()
    ...
    namespace {                                                               \
        namespace INTERNAL_CATCH_MAKE_NAMESPACE( TestName ) {                 \
            ...
            INTERNAL_CATCH_NTTP_REG_GEN(                                      \
                TestFunc, INTERNAL_CATCH_REMOVE_PARENS( Signature ) )         \
            template <typename... Types> struct CATCH_DLL_PUBLIC TestName {   \
                TestName() {                                                  \
                    size_t index = 0;                                         \
...
#define INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_2(                           \
    ...
    namespace {                                                               \
        namespace INTERNAL_CATCH_MAKE_NAMESPACE( TestName ) {                 \
            ...
            template <typename... Types>                                      \
            struct CATCH_DLL_PUBLIC TestNameClass {                           \
                TestNameClass() {                                             \
                    size_t index = 0;                                         \
                    constexpr char const* tmpl_types[] = { CATCH_REC_LIST(    \
                        INTERNAL_CATCH_STRINGIZE_WITHOUT_PARENS,              \
...
namespace Catch {
    ...
    class CATCH_DLL_PUBLIC IExceptionTranslator {
    public:
        virtual ~IExceptionTranslator(); // = default
        virtual std::string translate( ExceptionTranslators::const_iterator it, ExceptionTranslators::const_iterator itEnd ) const = 0;
    };

    class CATCH_DLL_PUBLIC IExceptionTranslatorRegistry {
    public:
...
namespace Catch {
    ...
    class CATCH_DLL_PUBLIC IReporterRegistry {
    public:
...
namespace Catch {
    ...
    [[noreturn]] CATCH_DLL_PUBLIC void
...
namespace Catch {
    ...
    namespace Detail {
        ...
        CATCH_DLL_PUBLIC Catch::Detail::unique_ptr<EnumInfo>
        ...
        CATCH_DLL_PUBLIC std::vector<StringRef> parseEnums( StringRef enums );
...
namespace Catch {
     ...
     */
    CATCH_DLL_PUBLIC auto makeStream( std::string const& filename ) -> Detail::unique_ptr<IStream>;
...
namespace Catch {
    ...
    class CATCH_DLL_PUBLIC TestCaseInfoHasher {
    public:
...
namespace Matchers {
    ...
    template<typename T>
    class CATCH_DLL_PUBLIC MatcherBase : public MatcherUntypedBase {
    public:
    ...
    namespace Detail {
        ...
        template<typename ArgT>
        class CATCH_DLL_PUBLIC MatchAllOf final : public MatcherBase<ArgT> {
        ...
        template<typename ArgT>
        class CATCH_DLL_PUBLIC MatchAnyOf final : public MatcherBase<ArgT> {
            std::vector<MatcherBase<ArgT> const*> m_matchers;
        public:
            MatchAnyOf() = default;
        ...
        template<typename ArgT>
        class CATCH_DLL_PUBLIC MatchNotOf final : public MatcherBase<ArgT> {
...
namespace Catch {
namespace Matchers {
    class CATCH_DLL_PUBLIC MatcherGenericBase : public MatcherUntypedBase {
    public:
    ...
    namespace Detail {
        ...
        class CATCH_DLL_PUBLIC MatchAllOfGeneric final : public MatcherGenericBase {
        public:
        ...
        template<typename... MatcherTs>
        class CATCH_DLL_PUBLIC MatchAnyOfGeneric final : public MatcherGenericBase {
        public:
        ...
        class CATCH_DLL_PUBLIC MatchNotOfGeneric final : public MatcherGenericBase {
            MatcherT const& m_matcher;
...
namespace Matchers {
    ...
    class CATCH_DLL_PUBLIC ExceptionMessageMatcher final
...
CATCH_DLL_PUBLIC ExceptionMessageMatcher Message( std::string const& message );
...
namespace Matchers {
    ...
    class CATCH_DLL_PUBLIC VectorContainsElementMatcher final : public MatcherBase<std::vector<T, Alloc>> {
    ...
    class CATCH_DLL_PUBLIC ContainsMatcher final : public MatcherBase<std::vector<T, AllocMatch>> {
    ...
    template<typename T, typename AllocComp, typename AllocMatch>
    class CATCH_DLL_PUBLIC EqualsMatcher final : public MatcherBase<std::vector<T, AllocMatch>> {
        std::vector<T, AllocComp> const& m_comparator;
    ...
    template<typename T, typename AllocComp, typename AllocMatch>
    class CATCH_DLL_PUBLIC ApproxMatcher final : public MatcherBase<std::vector<T, AllocMatch>> {
        std::vector<T, AllocComp> const& m_comparator;
    ...
    template<typename T, typename AllocComp, typename AllocMatch>
    class CATCH_DLL_PUBLIC UnorderedEqualsMatcher final : public MatcherBase<std::vector<T, AllocMatch>> {
...
namespace Catch {
    ...
    class CATCH_DLL_PUBLIC ConsoleReporter final : public StreamingReporterBase {
...
namespace Catch {
    ...
    class CATCH_DLL_PUBLIC TeamCityReporter final : public StreamingReporterBase {
    public:
