...
TEST_CASE( "std::pair<int,std::string> -> toString", "[toString]" )
{
    std::pair<int,std::string> pr { 34, "xyzzy" };
    REQUIRE( Catch::toString( pr ) == "{ 34, \"xyzzy\" }" );
}

TEST_CASE( "std::pair<int,const std::string> -> toString", "[toString]" )
{
    std::pair<int,const std::string> pr { 34, "xyzzy" };
    REQUIRE( Catch::toString( pr ) == "{ 34, \"xyzzy\" }" );
}

TEST_CASE( "std::vector<std::pair<std::string,int>> -> toString", "[toString]" )
{
...
TEST_CASE( "pair<pair<int,const char *,pair<std::string,int>> -> toString", "[toString]" )
{
