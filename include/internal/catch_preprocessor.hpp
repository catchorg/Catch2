...
#define INTERNAL_CATCH_STRINGIZE(...) #__VA_ARGS__
#define INTERNAL_CATCH_STRINGIZE_WITHOUT_PARENS(param) INTERNAL_CATCH_EXPAND1(INTERNAL_CATCH_DEF CATCH_DEFER(INTERNAL_CATCH_STRINGIZE)(INTERNAL_CATCH_REMOVE_PARENS(param)))
