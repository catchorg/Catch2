        ...
        namespace {                                                   \
            ...
            struct TestName {                                         \
                TestName() {                                          \
                    ...
                    int index = 0;                                    \
                    using expander = int[];                           \
                    constexpr char* tmpl_types[] = {CATCH_REC_LIST(INTERNAL_CATCH_STRINGIZE, INTERNAL_CATCH_REMOVE_PARENS(TmplTypes))};\
                    constexpr char* types_list[] = {CATCH_REC_LIST(INTERNAL_CATCH_STRINGIZE_WITHOUT_PARENS, INTERNAL_CATCH_REMOVE_PARENS(TypesList))};\
