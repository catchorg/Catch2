 ...
 */
#ifndef TWOBLUECUBES_CATCH_REPORTER_SLIM_HPP_INCLUDED
#define TWOBLUECUBES_CATCH_REPORTER_SLIM_HPP_INCLUDED
...
namespace Catch {
    ...
    struct SlimReporter : StreamingReporterBase {

        SlimReporter( ReporterConfig const& _config )
        : StreamingReporterBase( _config )
        {}

        virtual ~SlimReporter();

        static std::string getDescription() {
            return "Reports test results on a single line, for easy viewing";
        }
    ...
    INTERNAL_CATCH_REGISTER_REPORTER( "slim", SlimReporter )

} // end namespace Catch

#endif // TWOBLUECUBES_CATCH_REPORTER_SLIM_HPP_INCLUDED
