/*
 *  Created by Pete Goodliffe on 2013-12-06
 *  Copyright 2013 Pete Goodliffe. All rights reserved.
 *
 *  Distributed under the Boost Software License, Version 1.0. (See accompanying
 *  file LICENSE_1_0.txt or copy at http://www.boost.org/LICENSE_1_0.txt)
 */
#ifndef TWOBLUECUBES_CATCH_REPORTER_IDE_HPP_INCLUDED
#define TWOBLUECUBES_CATCH_REPORTER_IDE_HPP_INCLUDED
...
namespace Catch {
    ...
    struct IDEReporter : StreamingReporterBase {
        IDEReporter( ReporterConfig const& _config )
        ...
        static std::string getDescription() {
            return "Reports test results formatted for IDEs";
        }
        ...
        virtual void noMatchingTestCases( std::string const& spec ) {
            stream << "Error: No test cases matched '" << spec << "'" << std::endl;
        }
    ...
    private:
        ...
        private:
            ...
            void printOriginalMacro() const {
                if( result.hasExpression() ) {
                    stream << "for test:\n";
                    Colour colourGuard( Colour::OriginalExpression );
                    stream << Text( result.getExpressionInMacro(), TextAttributes().setIndent(2)) << "\n";
                }
            }
            void printReconstructedExpression() const {
                if( result.hasExpandedExpression() ) {
                    ...
                    Colour colourGuard( Colour::ReconstructedExpression );
                    stream << Text( result.getExpression() ) << "\n";
                }
            }
    ...
    INTERNAL_CATCH_REGISTER_REPORTER( "ide", IDEReporter )

} // end namespace Catch

#endif // TWOBLUECUBES_CATCH_REPORTER_IDE_HPP_INCLUDED
